...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # NOW SINCE OUR DEMO APPLICATION HAS ONLY 4 MENU BUTTONS: Home, cafeteria, exercises, about_us, WHEN USER PRESSES IT THE FOLLOWING CODE             ---------(C8)
...
# --PAGE cafeteria----------------------------------:
    # --CHANGING THE HEADING---------:
        # self.ui.lab_cafeteria.setText("your heading")

    # --USING PROGRESS BAR VALUE-----:
        # self.ui.progressBar_cafeteria.setValue(% in int)

    # --USING COMBO BOX--------------:
        # self.ui.comboBox_cafeteria.addItem("item") #TO ADD ITEMS IN THE COMBOBOX LIST
        # self.ui.comboBox_cafeteria.setItemText() #INDEX YOUR ADDED ITEM
        # self.ui.comboBox_cafeteria.currentIndex() #GIVES THE CURRENT INDEX OF THE LIST

    # --USING START BUTTON-----------:
        # self.ui.bn_cafeteria_start.clicked.connect(some function to execute) #THE FUNCTION GET ACTIVATED WHEN YOU CLICK THE BUTTON
...
# --PAGE exercises:CONTACT----------------------:
    ...
    # --USING TEXT FIELD-------------:
        # self.ui.line_android_name.setText("---")
        # TO GET WHAT THE USER HAS ENTERED.
    ...
    # --USING PUSH BUTTONS-----------:
        ...
        # self.ui.bn_android_contact_save.clicked.connect("function goes here")
